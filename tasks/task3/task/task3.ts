/**
 * @file task3.ts
 * @brief Solutions for the homework task4. Containing the next problems defined as the basic specification:
 * 
...
export { calculateDiscountedPrice, calculateTotalPrice } from './task3_1';
export { getFullName, filterUniqueWords, getAverageGrade } from './task3_2';
export { createCounter, repeatFunction } from './task3_3';
export { calculateFactorial, power } from './task3_4';
export { lazyMap, fibonacciGenerator } from './task3_5';
